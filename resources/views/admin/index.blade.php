            ...
            <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                @php
                    $cards = [
                        ...
                        ['Event-Status', 'Status-Lookups pflegen', 'verwaltung_event-status.jpg', route('admin.event-statuses.index')],
                        ['Gruppen', 'Gilden & Trupps verwalten', 'verwaltung_helden-gruppen.jpg', route('admin.groups.index')],
                        ['Audit-Log', 'Admin-Aktionen protokolliert', 'verwaltung_audit-log.jpg', route('admin.audit-logs.index')],
                        ['Portal-Einstellungen', 'Vereins-Settings bearbeiten', 'verwaltung_portal-einstellungen.jpg', route('admin.settings.index')],
                        ['Rollen & Rechte', 'Berechtigungsübersicht', 'verwaltung_rollen-rechte.jpg', route('admin.roles.index')],
                        ['Fertigkeiten', 'Fertigkeiten-Katalog pflegen', 'verwaltung_fertigkeiten.jpg', route('admin.skills.index')],
                        ['Perlenfarben', 'Perlenfarben pflegen', 'verwaltung_perlenfarbe.jpg', route('admin.perl-colors.index')],
                        ['EP-Buchungsarten', 'EP-Buchungsarten pflegen', 'verwaltung_ep-buchungsarten.jpg', route('admin.ep-transaction-types.index')],
                        ['Heldenausweise', 'Ausweise generieren & zuweisen', 'verwaltung_heldenausweise.jpg', route('admin.id-cards.index')],
                    ];
                @endphp
