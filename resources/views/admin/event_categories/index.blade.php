<x-app-layout>
    <x-slot name="header">
        <h2 class="font-uncial text-2xl text-waldritter leading-tight">Event-Kategorien</h2>
    </x-slot>

    <div class="py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="mb-4">
                <a href="{{ route('admin.event-categories.create') }}" data-modal-url="{{ route('admin.event-categories.create') }}" class="ui primary button">Neue Kategorie</a>
            </div>
            ...
            <div class="bg-white/70 border-2 border-[#5a3a22]/40 shadow sm:rounded-lg overflow-hidden">
                <table class="min-w-full divide-y divide-stone-200">
                    ...
                    <tbody class="divide-y divide-stone-200 text-stone-800">
                        ...
                        @empty
                            <tr><td colspan="4" class="px-6 py-4 text-stone-500">Noch keine Kategorien.</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
